...
6. [WSL](https://www.youtube.com/watch?v=A0eqZujVfYU)
...
7. [Homebrew](https://brew.sh/index_zh-tw) / [Chocolatey](https://chocolatey.org/)

   They are respectively the package manager of MacOS and Windows. With Linux, you usually have some built-in package manager already, but with MacOS and Windows, you want to use them.
