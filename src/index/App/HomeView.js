      ...
      <header className="relative h-screen font-pretty">
        ...
        <div className="absolute right-8 top-5">
          <button
              ...
              className="mb-4 block w-28 focus:outline-none text-graywhite-693 hover:text-white border-graywhite-693 hover:border-white text-md border-2 px-4 py-1.5 animate-fadein-1000-800"
          >
            Contact
          </button>
        </div>
