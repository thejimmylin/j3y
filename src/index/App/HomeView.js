      ...
      <header className="relative h-screen font-pretty">
        <div className="absolute w-full h-screen bg-graywhite-99 -z-10" style={{ transform: `translateY(${state.y / 2}px)` }}>
          <ProgressiveImgWrapper thumbnail={<img src={wallCompressed} alt="wallCompressed" className="object-cover w-full h-screen filter blur-2xl" />}>
            <img src={wall} alt="wall" className="object-cover w-full h-screen transition-filter duration-2000 ease-out" />
        ...
        <div ref={refAboutMe} className="max-w-screen-sm p-3 mx-auto bg-graywhite-105">
          <FadeinWrapper>
            <ProgressiveImgWrapper thumbnail={<img src={avatarCompressed} alt="avatar" className="w-full p-5 rounded-3xl filter blur-md" />}>
              <img src={avatar} alt="avatar" className="w-full p-5 rounded-3xl transition-filter duration-1000 ease-out" />
            </ProgressiveImgWrapper>
          </FadeinWrapper>
          ...
          <FadeinWrapper>
            ...
            <div className="p-5 grid grid-cols-12">
              <p className="col-span-9 text-md pr-2">
                <a className="underline text-graywhite-495 hover:text-white" href="https://www.ntu.edu.tw/">
              ...
              <div className="col-span-3 px-4">
                <ProgressiveImgWrapper thumbnail={<img src={ntuCompressed} alt="ntuCompressed" className="filter blur-md" />}>
                  <img src={ntu} alt="ntu" className="transition-filter duration-1000 ease-out" />
                </ProgressiveImgWrapper>
              </div>
            </div>
          </FadeinWrapper>
            ...
            <div className="p-5 grid grid-cols-12">
              ...
              <div className="col-span-3">
                <ProgressiveImgWrapper thumbnail={<img src={chiefCompressed} alt="chiefCompressed" className="filter blur-md" />}>
                  <img src={chief} alt="chief" className="transition-filter duration-1000 ease-out" />
                </ProgressiveImgWrapper>
              </div>
            </div>
          </FadeinWrapper>
          ...
          <FadeinWrapper>
            ...
            <p className="p-5 text-md">
              Contact me with{" "}
              <a href="mailto:b00502013@gmail.com" className="underline text-graywhite-495 hover:text-white">
                Email
              </a>{" "}
              or{" "}
          ...
          <FadeinWrapper>
            <p className="p-5 pb-10 flex">
              ...
              <a href="https://www.instagram.com/j3y.ig/" target="_blank" rel="noreferrer" className="pr-4 underline text-graywhite-495 hover:text-white">
              ...
              <a href="https://www.facebook.com/j3y.fb" target="_blank" rel="noreferrer" className="pr-4 underline text-graywhite-495 hover:text-white">
              ...
              <a href="https://twitter.com/j3ytweeting" target="_blank" rel="noreferrer" className="pr-4 underline text-graywhite-495 hover:text-white">
