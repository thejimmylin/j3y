  ...
  return (
    <div className="max-w-screen-md p-4 mx-auto">
      <FadeinWrapper>
        ...
        >
          <Image src={avatar} alt="avatar" layout="responsive" className="rounded-sm" />
        </div>
      </FadeinWrapper>
      ...
      <FadeinWrapper>
        ...
        <div className="my-8 mr-4 ml-12 grid grid-cols-12 gap-x-3">
          ...
          <div className="col-span-3">
            <div
              className={classNames("transition-filter", "ease-out", "duration-1000", {
                "blur-md": !loaded,
              })}
            >
      ...
      <FadeinWrapper>
        ...
        <div className="my-8 mr-4 ml-12 grid grid-cols-12 gap-x-3">
          <div className="col-span-9">
            ...
            <p className="mt-8">
              I work for their cloud service department. I maintain and develop products
              and services about{" "}
              <a
      ...
      <FadeinWrapper>
        ...
        <p className="my-8 mr-4 ml-20">
          ...
          FortiAdmin, It is possible to set their own config without interfere with each
          other for different users.
        </p>
        <p className="my-8 mr-4 ml-20">
          Features:
          <br />
      ...
      <FadeinWrapper>
        ...
        <p className="my-8 mr-4 ml-12">
          ...
          web development with Django for over 5 years. I can build modern, well-tested
      ...
      <FadeinWrapper>
        ...
        <p className="my-8 mr-4 ml-12">
          Django has a great model/ORM system, which makes it possible to creating a web
          application without writing SQL. But sometimes SQL knowledge is important,
          too. It is true especially when it comes to a extremely complicated queriy or
      ...
      <FadeinWrapper>
        ...
        <p className="my-8 mr-4 ml-12">
          ...
          , but it is much more flexible and easy to customize, which prevents you from
          building a lot of similar web.
        </p>
      </FadeinWrapper>
      ...
      <FadeinWrapper>
        ...
        <p className="my-8 mr-4 ml-12">
          ...
          development. If a feature can't be delivered to the users, the resources spent
          on development will be wasted.
        </p>
      </FadeinWrapper>
      ...
      <FadeinWrapper>
        ...
        <p className="my-8 mr-4 ml-12">
          ...
          , which frees me from a lot of environment and compatibility concerns. Docker
          greatly increases the portability and flexibility of the services.
        </p>
      </FadeinWrapper>
